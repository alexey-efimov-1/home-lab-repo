...
> [!warning]
> Очень нестабильная комбинация. Использовать только в крайне случае, если работать нужно принципиально с win-машины. Постоянные конфликты гипервизора с железом.
